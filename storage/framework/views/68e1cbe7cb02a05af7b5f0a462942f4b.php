                ...
                <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
                    <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Empresas: <?php echo e($totalCompanies); ?><br>
                                Clientes: <?php echo e($totalClients); ?><br>
                                Facturas: <?php echo e($totalInvoices); ?><br>
                                Productos: <?php echo e($totalProducts); ?>
                    ...
                    <div class="scale-100 p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Ingresos Totales: €<?php echo e(number_format($totalRevenue, 2)); ?><br>
                                Gastos Totales: €<?php echo e(number_format($totalExpenses, 2)); ?><br>
                                Beneficio Neto: €<?php echo e(number_format($netIncome, 2)); ?>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <?php $__currentLoopData = $recentInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">€<?php echo e(number_format($invoice->total, 2)); ?></td>
                        ...
                        <div class="mt-2 text-sm text-gray-500">
                            <table class="min-w-full divide-y divide-gray-200">
                                ...
                                <?php $__currentLoopData = $topClients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($client->name); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($client->invoices_count); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">€<?php echo e(number_format($client->invoices_sum_total, 2)); ?></td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
